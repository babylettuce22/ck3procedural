...
public static class ArtifactWriter
{
    public static void WriteTemplates(string modDir)
    {
        ...
        string[] templates = { "gen_weapon_template", "gen_armor_template", "gen_crown_template", "gen_regalia_template", "gen_book_template" };
    ...
    public static void WriteOnGameStart(string modDir, ArtifactMap artifacts)
    {
        ...
        foreach (var (county, arts) in artifacts.ByCounty)
        {
            ...
            foreach (var art in arts)
            {
                ...
                sb.Append($"\t\t\t\tvisuals = placeholder\n"); // Using vanilla placeholder visual from 000_placeholder.txt
    ...
    public static void WriteLocalisation(string modDir, ArtifactMap artifacts)
    {
        ...
        {
            sb.Append($" {art.NameKey}: \"{art.LocalizedName}\"\n");
            sb.Append($" {art.DescriptionKey}: \"{art.LocalizedDescription}\"\n");
        }
